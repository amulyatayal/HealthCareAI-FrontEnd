...
export function HealthHub() {
  ...
  const features = [
    { icon: Smile, title: 'Basic Mood Diary', subtitle: 'Quick 0-10 mood tracking', to: `${base}/health/mood`, iconColor: 'amber', priority: 'P0' as const },
    { icon: Sparkles, title: 'Advanced Mood Diary', subtitle: 'Detailed emotions and patterns', to: `${base}/health/mood-advanced`, iconColor: 'purple', priority: 'P1' as const },
    { icon: Activity, title: 'Symptom Tracker', subtitle: 'Log and monitor symptoms', to: `${base}/health/symptoms`, iconColor: 'blue', priority: 'P1' as const },
    { icon: ClipboardList, title: 'PROM Questionnaire', subtitle: 'Patient-reported outcome questionnaire', to: `${base}/health/prom/breast-satisfaction`, iconColor: 'pink', priority: 'P1' as const },
    { icon: Timer, title: 'Physical Tests and Wearable Integration', subtitle: '1 Mile, Sit-to-Stand, Balance, device sync', to: `${base}/health/tests`, iconColor: 'green', comingSoon: true },
  ]
  ...
  return (
    <WireframeLayout>
      ...
      {features.map((feature) => {
        const card = (
          <WireframeCard style={feature.comingSoon ? undefined : { transition: 'all 0.2s ease', cursor: 'pointer' }}>
